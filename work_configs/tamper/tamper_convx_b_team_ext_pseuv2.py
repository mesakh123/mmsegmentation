...
log_level = "INFO"
load_from = "./work_dirs/tamper/convx_b_team_ext_pseu_ft2_20k/latest.pth"
resume_from = None
workflow = [("train", 1)]
...
evaluation = dict(
    by_epoch=False, interval=10 * 1000, metric=["mIoU", "mFscore"], pre_eval=True
)
fp16 = dict()

work_dir = f"./work_dirs/tamper/convx_b_team_ext_pseuv2_{total_iters}k"
